...
const BENTO_CARDS = [
  ...
  { id: 2, label: "AI Models", icon: Brain, colSpan: "col-span-1", rowSpan: "row-span-1", content: "Aether-v4", desc: "Active", color: "text-violet-400", iconBg: "bg-violet-400/10", hoverGlow: "group-hover:shadow-[0_12px_40px_rgba(139,92,246,0.12)]", hoverBorder: "group-hover:border-violet-400/20" },
